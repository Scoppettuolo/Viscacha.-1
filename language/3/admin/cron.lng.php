...
$lang['admin_err_upload_failed'] = 'Archivo no se pudo be uploaded.';
...
$lang['admin_job_successfully_added'] = 'Cron Job correctamente added';
$lang['admin_manage_tasks'] = 'Manage Tasks';
$lang['admin_minute'] = 'Minute:';
$lang['admin_month'] = 'Month:';
$lang['admin_option_choose_a_file'] = '-- Por favor choose a file --';
...
$lang['admin_status_enabled_info'] = 'Because Cron Jobs are often not availible, Viscacha can simulate Cron Jobs. This works as follows: On every page call, it will be checked if there should han sido a Cron Job executed. If the time limit of a Cron Job is exceeded, it will be executed in the background.';
$lang['admin_tasks_logfile'] = 'Tasks Log Archivo';
$lang['admin_th_days'] = 'Day(s)';
$lang['admin_th_delete'] = 'Eliminar';
$lang['admin_th_file'] = 'Archivo';
...
$lang['admin_title_description'] = 'Título / Descripción:';
$lang['admin_upload_a_file'] = '<em>or</em> upload a file:';
$lang['admin_upload_a_file2'] = 'Todosowed file types: .php<br />Maximum file size: 100 KB';
