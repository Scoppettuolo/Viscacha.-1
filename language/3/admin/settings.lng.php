...
$lang['admin_acp_standard_language'] = 'Predeterminado language for the Admin CP:';
$lang['admin_acp_standard_language_info'] = 'This language will be only used in the Admin CP.';
$lang['admin_activate_flodblocking'] = 'Activate Floodblocking for Buscar:';
...
$lang['admin_activate_gzip_compression_info'] = 'Seleccionaring yes will enable GZIP to reduce bandwidth requirements, but there will be a small performance overhead instead. This feature requires the Zlib library, which is {$gzip}! If you are already using mod_gzip on your server, do not enable this option.';
...
$lang['admin_activate_newsfeed_info'] = 'The Noticiasfeed-Formats can be administered <a href="admin.php?action=misc&amp;job=feedcreator">here</a>.';
$lang['admin_activate_spambot_at_guests'] = 'Spam-Bot-Protection at Mensajeing of guests';
$lang['admin_activate_spambot_registration'] = 'Spam-Bot-Protection at Registro:';
$lang['admin_activation_admin'] = 'Activation through Administrador';
$lang['admin_activation_email'] = 'Activation per e-mail';
$lang['admin_activation_email_and_admin'] = 'Activation per e-mail and through Administrador';
...
$lang['admin_active_tread_uploads'] = 'Activate Mensaje Uploads:';
$lang['admin_add_settings'] = 'Add Setting';
$lang['admin_add_settings_group'] = 'Add Setting group';
$lang['admin_admin_control_pandel'] = 'Administration Panel de control';
$lang['admin_admin_control_pandel_info'] = 'Here you can set some options related to this Administration Panel de control.';
$lang['admin_admin_control_panel_settings'] = 'Administration Panel de control Ajustes';
$lang['admin_admin_control_panel_settings_lang'] = 'Administration Panel de control Ajustes &raquo; Idioma Ajustes';
$lang['admin_admin_edit'] = 'Administration';
$lang['admin_allowed_file_format_ava'] = 'Todosowed file formats for profile pictures:';
$lang['admin_allowed_file_format_ava_info'] = 'Each fily type separated by ",". Without leading dot!<br />Possible file types:';
$lang['admin_allowed_file_format_uploads'] = 'Todosowed Archivo Formats for Upload:';
$lang['admin_allowed_file_format_uploads_info'] = 'Each file type separated by ",". Without leading dot!';
$lang['admin_allow_change_name'] = 'Todosow users to change their username:';
$lang['admin_allow_change_name_info'] = 'If this option is activated, the users are able to change their username.';
$lang['admin_allow_guest_to_post_without_email'] = 'Todosow guests to post without specifying an e-mail-address:';
$lang['admin_allow_users_to_filter_members'] = 'Todosow users to filter members by group:';
...
$lang['admin_all_settings_deleted'] = 'Todos settings for this package han sido deleted.';
...
$lang['admin_bb_text_progressing_info'] = 'BB-Codes, Wordwrap, Emoticonos, Censor, Glossary, Vocabulary, ...';
$lang['admin_bb_text_smileys'] = 'BB-Code &amp; Text processing &raquo; Emoticonos';
$lang['admin_bb_text_wordwrap'] = 'BB-Code &amp; Text processing &raquo; Wordwrap';
$lang['admin_black_trash_email'] = 'Block "Trash"-Correo electrónico Addresses:';
$lang['admin_black_trash_email_info'] = 'The Domains can be edited <a href="admin.php?action=misc&job=sessionmails">here</a>.';
$lang['admin_cannot_authenticate_at_ftp_server'] = 'No se pudo authenticate to ftp server! Pleasy try again later or check the ftp authentication settings (username, password)!';
$lang['admin_cannot_connect_to_ftp_server'] = 'No se pudo connect to ftp server! Pleasy check the ftp server settings (server, port)!';
...
$lang['admin_configure_ftp_connection'] = 'Configurar FTP Connection';
$lang['admin_connection_is_ok'] = 'Connection seems to be ok!';
$lang['admin_content_syndication'] = 'Contenido Syndication (Javascript, RSS, ...)';
$lang['admin_correct_all_caps'] = 'Correct uppercase:';
$lang['admin_correct_all_caps_info'] = 'If the whole title is capitalized, only the first letter of each word will be capitalized. Example: "NEED HELP!" will be "Need Ayuda!"';
$lang['admin_crawler_robots'] = 'Crawler &amp; Robots';
$lang['admin_current_version'] = 'Current version:';
$lang['admin_custom_delete'] = 'Eliminar';
$lang['admin_custom_setting'] = 'Setting';
$lang['admin_custom_settings'] = 'Custom Ajustes';
...
$lang['admin_database_driver'] = 'Base de datos Driver:';
$lang['admin_database_edit'] = 'Base de datos';
...
$lang['admin_database_name'] = 'Base de datos Nombre:';
$lang['admin_database_prefix'] = 'Base de datos Tables Prefix:';
$lang['admin_database_prefix_info'] = 'Prefix for the tables of this Viscacha installation.!';
$lang['admin_database_username'] = 'Base de datos Nombre de usuario:';
$lang['admin_date_time_edit'] = 'Fecha and Time';
...
$lang['admin_dession_ip_valadtion'] = 'Sesión IP validation:';
$lang['admin_dession_ip_valadtion_info'] = 'Makes a take over more difficult. Determines how much of the users IP is used to validate a session. Todos compares the complete address (this is not recommended), A.B.C the first x.x.x (recommended), A.B the first x.x, Ninguno disables checking.';
...
$lang['admin_disallow_ot'] = 'Disallow [ot]-BB-Code (Off-Tema):';
$lang['admin_dispatch_internal_mail'] = 'PHP internal Mail-Function';
$lang['admin_dispatch_sendmail'] = 'Enviarmail-Dispatch';
...
$lang['admin_email_edit'] = 'Correo electrónicos';
$lang['admin_email_for_reports'] = 'Correo electrónico-address for reports:';
$lang['admin_email_notify_new_member'] = 'Dirección de correoes to notify when there is a new member:';
...
$lang['admin_enable_change_vote'] = 'Todosow to change one\'s mind of a survey';
$lang['admin_enable_change_vote_info'] = 'This option allows members to change their vote in surveys again.';
$lang['admin_enable_postrating'] = 'Enable and show Mensajerating:';
...
$lang['admin_form_add_group'] = 'Add Grupo';
$lang['admin_form_add_setting'] = 'Add Setting';
$lang['admin_form_go'] = 'Ir';
$lang['admin_form_submit'] = 'Enviar';
$lang['admin_forum_categories_edit'] = 'Foros &amp; Categorías';
$lang['admin_forum_email'] = 'Foro e-mail-address:';
$lang['admin_forum_email_info'] = 'Will be used for every outgoing e-mail.';
$lang['admin_from_timezone'] = 'Foro Zona horaria:';
$lang['admin_from_timezone_info'] = 'Standard Zona horaria for the Foro!';
$lang['admin_ftp_command_log'] = 'FTP-Command-Log:';
$lang['admin_ftp_connection_test'] = 'FTP Connection Test';
$lang['admin_ftp_directory_does_not_exist'] = 'Directorio "{$ftp_path}" does not exist!';
$lang['admin_ftp_password'] = 'FTP-Contraseña:';
$lang['admin_ftp_php_extension_error'] = 'Viscacha needs at least fsockopen, sockets extension or ftp extension to work! Por favor enable one of this features or disable ftp.';
...
$lang['admin_ftp_settings'] = 'FTP Ajustes';
$lang['admin_ftp_startpath'] = 'FTP-Startpath:';
$lang['admin_ftp_startpath_info'] = 'Path, from which the FTP-Program works. This path should be the relative FTP-path to your Viscacha-Instalaration. If the directory containing Viscacha is your FTP-account path, you just need an &quot;/&quot; under *nix-systems. Path determined by the script:<code>{$path}</code>';
$lang['admin_ftp_username'] = 'FTP-Nombre de usuario:';
$lang['admin_gd_not_found'] = 'GD not found!';
$lang['admin_gd_version'] = 'GD Versión:';
$lang['admin_gd_version_info'] = 'Versión of <a href="http://www.boutell.com/gd/" target="_blank">GD</a> installed on your server. You can find the version by searching for \'GD\' on your <a href="admin.php?action=misc&job=phpinfo" target="Main">phpinfo()</a> output. Detected GD Versión:';
$lang['admin_general_forum_settings'] = 'General Foro Ajustes';
$lang['admin_group_inserted'] = 'Grupo correctamente inserted!';
$lang['admin_group_name'] = 'Grupo Nombre';
...
$lang['admin_group_name_short_long'] = 'Grupo Nombre is too short or too long.';
$lang['admin_group_settings_description'] = 'Descripción';
...
$lang['admin_headers_cookies_gzip'] = 'Cabeceras, Cookies &amp; GZIP';
$lang['admin_height_pic_pixels'] = 'Height for resized Pictures in Pixels:';
$lang['admin_htaccess_error_doc'] = '.htaccess: Use Error-Documentoos:';
...
$lang['admin_important_tabels'] = 'Importarant Tables:';
...
$lang['admin_insert_email_new_feeds'] = 'Insert Correo electrónicos into created news feeds:';
...
$lang['admin_length_of_post_text'] = 'Length of Mensajes:';
$lang['admin_length_of_post_title'] = 'Length of Títulos:';
$lang['admin_length_of_topic'] = 'Length of titles in the "Last Tema"-column:';
...
$lang['admin_limit_downloadspeed_info'] = 'Here you can throttle the Downloadspeed for Mensaje Uploads! Indicate the max. Dowloadspeed <b> in KB </b> . 0 = No Limit';
...
$lang['admin_login_attempts_time_info'] = 'Enter in minutes the time before any wrong passwords submitted by a user is reset to 0. Por favor note also that once a user has correctamente logged in, the data is deleted for that person.';
...
$lang['admin_max_filesize_upload_info'] = 'Max. Archivo Size for Upload in Bytes:';
...
$lang['admin_max_number_uploads'] = 'Max. Number of Uploads per Mensaje:';
...
$lang['admin_max_sig_length'] = 'Maximum Firma length:';
...
$lang['admin_memberlist_avatar'] = 'Perfil picture / Avatar (Imagen)';
$lang['admin_memberlist_birthday'] = 'Fecha of Birth (Fecha)';
$lang['admin_memberlist_date_register'] = 'Fecha or registration (Fecha)';
$lang['admin_memberlist_edit'] = 'Miembrolist';
$lang['admin_memberlist_email'] = 'Correo electrónico (Icon)';
$lang['admin_memberlist_field_options'] = 'Miembrolist Field Opciones:';
$lang['admin_memberlist_field_options_info'] = 'What user profile fields should be shown on the member list page?';
$lang['admin_memberlist_grender'] = 'Género';
$lang['admin_memberlist_hp'] = 'Iniciopage (Icon)';
$lang['admin_memberlist_icq'] = 'ICQ-UIN (Icon)';
$lang['admin_memberlist_jabber'] = 'Jabber (Icon)';
$lang['admin_memberlist_last_visit'] = 'Last visit (Fecha and time)';
$lang['admin_memberlist_location'] = 'Ubicación';
$lang['admin_memberlist_msn'] = 'MSN- and Windows-Messenger (Icon)';
$lang['admin_memberlist_online-status'] = 'User online status (Icon)';
$lang['admin_memberlist_per_page'] = 'Miembros per Page:';
$lang['admin_memberlist_per_page_info'] = 'Number of Miembros in the Miembrolist shown per page.';
$lang['admin_memberlist_pm'] = 'Mensaje privado (Icon)';
$lang['admin_memberlist_posts'] = 'Mensajes';
...
$lang['admin_min_length_search'] = 'Minimum length of Buscarterm:';
...
$lang['admin_multiple_instant_notifications'] = 'Enviar one e-mail subscriptions per reply:';
...
$lang['admin_name_exists'] = 'Nombre already exists';
$lang['admin_newsfeed_icon'] = 'Noticiasfeed icon:';
...
$lang['admin_number_active_topics'] = 'Number of active Temas per Page:';
$lang['admin_number_of_pm'] = 'Number of private Mensajes per page:';
$lang['admin_number_of_subscriptions_per_page'] = 'Number of Subscriptions/Favorites per Page:';
$lang['admin_number_of_topics'] = 'Number of Temas per Foropage:';
$lang['admin_number_of_topics_info'] = 'Number of topics that in the topic overview are shown per page.';
$lang['admin_number_search_results'] = 'Number of Resultados de búsqueda per Page:';
$lang['admin_offline_msg'] = 'Fuera de línea message:';
...
$lang['admin_path_forum'] = 'Path to the Foro:';
...
$lang['admin_php_web_file_edit'] = 'PHP, Webserver and Archivosystem';
...
$lang['admin_positions_for_navigation'] = 'Positions for Navegación:';
...
$lang['admin_posts_per_page'] = 'Number of Mensajes per Page:';
$lang['admin_post_order_new'] = 'Mensajes nuevos first';
$lang['admin_post_order_old'] = 'Old posts first';
$lang['admin_post_order_title'] = 'Mensaje order for topics:';
...
$lang['admin_prevent_browser_caching_info'] = 'Enviar no-cache HTTP headers. These are very effective, so adding them may cause server load to increase due to an increase in page requests.';
$lang['admin_profile_edit_view'] = 'Perfil (edit &amp; view)';
$lang['admin_profil_avatar_edit'] = 'Perfil pictures &amp; Avatars';
...
$lang['admin_registration_edit'] = 'Registro';
...
$lang['admin_save_php_errors'] = 'Guardar PHP-Errors to log-file:';
...
$lang['admin_search_edit'] = 'Buscar';
$lang['admin_select_add_category'] = 'Add new Categoría';
$lang['admin_select_add_forum'] = 'Add new Foro';
$lang['admin_select_add_moderator'] = 'Add Moderador';
$lang['admin_select_add_robot'] = 'Add new Robot';
$lang['admin_select_add_task'] = 'Add new Task';
$lang['admin_select_backup'] = 'Copia de seguridad';
$lang['admin_select_banned_members_ip'] = 'Suspendido Miembros and IP Addresses';
...
$lang['admin_select_docoments_pages'] = 'Documentoos & Páginas';
$lang['admin_select_email_texts'] = 'Correo electrónico-texts (only default language)';
$lang['admin_select_execute_slq'] = 'Execute SQL Queries';
$lang['admin_select_export_feeds'] = 'Exportar/Crear Feeds';
$lang['admin_select_filemanager'] = 'Archivo Manager';
$lang['admin_select_file_type_manager'] = 'Archivo Type Manager';
$lang['admin_select_forum_categorie_manager'] = 'Foro &amp; Categoría Manager';
...
$lang['admin_select_import_feeds'] = 'Importar Feeds';
$lang['admin_select_manage_member'] = 'Manage Miembros';
$lang['admin_select_memberrating'] = 'Miembroratings';
$lang['admin_select_moderate_members'] = 'Moderate/Unlock Miembros';
$lang['admin_select_moderator_manager'] = 'Moderador Manager';
$lang['admin_select_navigation_manager'] = 'Navegación Manager';
$lang['admin_select_newsletter_manager'] = 'Noticiasletter & Correo electrónico Manager';
$lang['admin_select_online_status'] = 'En línea Estado Indication';
...
$lang['admin_select_pm_statistics'] = 'Mensaje privado Estadísticas';
$lang['admin_select_postratings'] = 'Mensajeratings';
$lang['admin_select_profile_field_manager'] = 'Perfil Field Manager';
$lang['admin_select_registration_statistic'] = 'Registro Estadísticas';
$lang['admin_select_restore'] = 'Restaurar';
$lang['admin_select_scheduled_tasks'] = 'Scheduled Tasks Manager';
$lang['admin_select_search_ip'] = 'Buscar IP Addresses';
$lang['admin_select_search_member'] = 'Buscar for Miembros';
$lang['admin_select_smiley_manager'] = 'Smiley Manager';
$lang['admin_select_status_database'] = 'Estado &amp; Base de datos';
...
$lang['admin_select_topic_posts_statistic'] = 'Tema &amp; Mensajes Estadísticas';
$lang['admin_select_trash_email'] = 'Trash Dirección de correoes';
$lang['admin_select_usergroup_manager'] = 'Usergroup Manager';
$lang['admin_select_vocabulary_manager'] = 'Vocabulary Manager';
$lang['admin_sendmail_host'] = 'Enviarmail - Host:';
$lang['admin_sendmail_host_info'] = 'Only if Enviarmail is activated.';
$lang['admin_send_reports_email'] = 'Enviar reports per e-mail:';
$lang['admin_servers_for_package_browser'] = 'Servers for the Paquete Browser:';
$lang['admin_servers_for_package_browser_info'] = 'One line per URL (without trailing slash).';
$lang['admin_server_connection_failed'] = 'No se pudo connect to server.';
...
$lang['admin_session_all'] = 'Todos';
$lang['admin_session_a_b'] = 'A.B';
$lang['admin_session_a_b_c'] = 'A.B.C';
$lang['admin_session_edit'] = 'Sesiónsystem';
$lang['admin_session_id_length'] = 'Sesión-ID length:';
$lang['admin_session_none'] = 'Ninguno';
$lang['admin_settings_description'] = 'Descripción';
$lang['admin_settings_management_tools'] = 'Related Management Tools';
$lang['admin_setting_add_setting_group'] = 'Add Setting Grupo';
$lang['admin_setting_attachments'] = 'Adjuntos';
$lang['admin_setting_attachments_info'] = 'Tema and post attachments: file size, file types, thumbnails, ...';
$lang['admin_setting_avatar'] = 'Perfil pictures (Avatars)';
...
$lang['admin_setting_custom_settings'] = 'Custom Ajustes';
$lang['admin_setting_database'] = 'Base de datos';
$lang['admin_setting_database_info'] = 'Base de datos configuration: Host, user, password, database, system etc.';
$lang['admin_setting_date_time'] = 'Fecha and Time';
$lang['admin_setting_date_time_info'] = 'Fechaformat and timeoutput, timezone and something similar.';
$lang['admin_setting_deleted'] = 'Custom Setting deleted!';
$lang['admin_setting_delete_group'] = 'Eliminar Grupo';
$lang['admin_setting_description'] = 'Descripción';
$lang['admin_setting_email_option'] = 'Correo electrónico Opciones';
$lang['admin_setting_email_option_info'] = 'Correo electrónico-delivery: PHP, SMTP, Enviarmail';
$lang['admin_setting_forums_categiries'] = 'Foros &amp; categories';
$lang['admin_setting_forums_categiries_info'] = 'Foros, subforums, statistics and categories.';
...
$lang['admin_setting_general'] = 'General Ajustes';
$lang['admin_setting_general_info'] = 'General settings like changing names or addresses.';
$lang['admin_setting_group'] = 'Grupo';
$lang['admin_setting_group_deleted'] = 'Custom Setting Grupo deleted!';
$lang['admin_setting_group_title'] = 'Título';
$lang['admin_setting_http_cookie_compression'] = 'HTTP, Cookies &amp; Compression';
$lang['admin_setting_http_cookie_compression_info'] = 'Cookies, Page compression and HTTP-Cabeceras.';
$lang['admin_setting_inserted'] = 'Setting correctamente inserted!';
$lang['admin_setting_member_team_list'] = 'Miembro List &amp; Team List';
$lang['admin_setting_member_team_list_info'] = 'Miembro- &amp; Teamlist settings.';
$lang['admin_setting_name'] = 'Setting Nombre';
...
$lang['admin_setting_none'] = 'Ninguno';
$lang['admin_setting_not_available'] = 'Custom setting not available.';
$lang['admin_setting_option'] = 'Opciones';
$lang['admin_setting_package_details'] = 'Paquete Details';
$lang['admin_setting_pm'] = 'Private Messaging';
$lang['admin_setting_pm_info'] = 'Private Messaging settings.';
$lang['admin_setting_posts_topics'] = 'Mensajes &amp; Temas';
$lang['admin_setting_posts_topics_info'] = 'Minimum lengths and maximum lengths, editing and other settings on posts and topics.';
$lang['admin_setting_profile_edit'] = 'Perfil (View &amp; Editar)';
$lang['admin_setting_profile_edit_info'] = 'Perfil settings, fields lengths and more.';
$lang['admin_setting_registration'] = 'Registro';
$lang['admin_setting_registration_info'] = 'Registro and Foro rules.';
$lang['admin_setting_scheduled_task'] = 'Scheduled Tasks (Cron Jobs)';
$lang['admin_setting_scheduled_task_info'] = 'Ajustes related to the <a href="admin.php?action=cron&amp;job=manage">Scheduled Tasks</a> (Cron Jobs).';
$lang['admin_setting_search'] = 'Buscar';
$lang['admin_setting_search_info'] = 'Resultados de búsqueda and search settings.';
...
$lang['admin_setting_sessionsystem'] = 'Sesiónsystem';
$lang['admin_setting_sessionsystem_info'] = 'Flood blocking und Sesións in the Foro.';
$lang['admin_setting_signature'] = 'Firmas';
$lang['admin_setting_signature_info'] = 'Firma settings like BB-Code limits.';
$lang['admin_setting_spam_bot'] = 'Spam-Bot-Protection';
$lang['admin_setting_spam_bot_info'] = 'Imagen based verification to prevent automatic registration or posting. Spam-Bot-Protection with <a href="admin.php?action=misc&amp;job=captcha">CAPTCHA</a>-Imágenes.';
...
$lang['admin_setting_title'] = 'Setting Título';
$lang['admin_setting_type'] = 'Setting Type';
$lang['admin_setting_type_values'] = 'Setting Type Values';
$lang['admin_setting_type_values_info'] = 'Only for Seleccionar-Fields.<br /><strong>Format:</strong> (each entry in a new line)<br /><code>value=title</code><br /><code>value</code> is a value which can only contain letters, numbers and underscores.<br /><code>title</code> is a one line value shown in the select box.';
$lang['admin_setting_viscacha'] = 'Viscacha Ajustes';
...
$lang['admin_show_memberrating'] = 'Show Miembrorating:';
$lang['admin_show_memberrating_info'] = 'Show the rating based on the postrating.';
$lang['admin_show_mod_rights'] = 'Show time period of Moderador rights:';
...
$lang['admin_show_subforums_in_overview'] = 'Show Subforums in Forooverview:';
$lang['admin_signatures_edit'] = 'Firmas';
$lang['admin_smtp_host'] = 'SMTP - Host:';
$lang['admin_smtp_host_info'] = 'Only if SMTP is activated.';
$lang['admin_smtp_password'] = 'SMTP - Contraseña:';
$lang['admin_smtp_username'] = 'SMTP - Nombre de usuario:';
...
$lang['admin_spambot_recaptcha'] = 'reCaptcha Ajustes';
...
$lang['admin_spambot_veriword'] = 'VeriWord Ajustes';
...
$lang['admin_standard_language_temp'] = 'Guardar language settings only based on sessions:';
$lang['admin_standard_language_temp_info'] = 'If you choose this option, this settings only affects your user account during the current session. If you do not choose this option, this setting will be saved globally and every User will have the language defined above as the standard language for the Admin CP. This option overrides the settings from the profile settings and the global forum settings. This option has no effect if you choose the option "Predeterminado language of the user" in the above field.';
...
$lang['admin_switch_cms_portal'] = 'Which file should be used as Iniciopage:';
$lang['admin_switch_forum'] = 'Forooverview';
...
$lang['admin_sync_forumstatistic'] = 'Syncronize Forostatistics on change:';
$lang['admin_sync_forumstatistic_info'] = 'Not recommended for big Foros! If this option is activated, the number of posts, topics etc. will be equalized with data assets by every change, otherwise it will be adapted manually.';
$lang['admin_task_log_file'] = 'Use Task-Log-Archivo:';
...
$lang['admin_test_ftp_connection'] = 'Guardar data and if so test FTP connection';
$lang['admin_thread_upload_edit'] = 'Mensaje Uploads';
$lang['admin_timelimit_post_delete'] = 'Time Limit on Deleting of Mensajes:';
$lang['admin_timelimit_post_delete_info'] = 'Time limit (in minutes) to impose on deleting of messages. After this time limit only moderators will be able to delete the message. 0 = Desactivado.';
$lang['admin_timelimit_post_edit'] = 'Time Limit on Editaring of Mensajes:';
$lang['admin_timelimit_post_edit_info'] = 'Time limit (in minutes) to impose on editing of messages. After this time limit only moderators will be able to edit the message. 0 = Desactivado.';
...
$lang['admin_time_check_inactive_users'] = 'Time for check on inactive users in Sesión-table:';
$lang['admin_time_check_inactive_users_info'] = 'in seconds';
$lang['admin_title_short_long'] = 'Título is too short or too long.';
$lang['admin_topics_posts_rating'] = 'Temas &amp; Mensajes &raquo; Mensajerating';
$lang['admin_topics_posts_title'] = 'Temas &amp; Mensajes';
$lang['admin_topics_subscriptions'] = 'Temas & Mensajes » Subscriptions';
$lang['admin_type_checkbox'] = 'Checkbox';
$lang['admin_type_select'] = 'Seleccionar';
...
$lang['admin_update_posts_immediately'] = 'Actualizar posts immediately:';
...
$lang['admin_user_standard_language_for_acp'] = 'Predeterminado language of the user';
$lang['admin_use_extended_navigation_interface'] = 'Use extended Navegación Interface:';
...
$lang['admin_ws_offline'] = 'Fuera de línea';
$lang['admin_ws_online'] = 'En línea';
